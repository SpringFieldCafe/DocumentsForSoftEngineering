...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth,height=0.5\textheight,keepaspectratio]{SwimLane.png}
    \caption{3.1.2 总体泳道图}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth, height=0.45\textheight, keepaspectratio]{SystemActivity.png}
    \caption{3.1.3 总体活动图}
\end{figure}
